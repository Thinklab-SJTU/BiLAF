...
from datasets.CUB200_dataset import Cub2011
...
def extract_features(args):
    ...
    if 'dino' in args.pretrained_weights or args.pretrained_weights == "":
        ...
        print("Building model from pretrained weights")
    ...
    if args.dataset == "CIFAR10":
        ...
        dataset = Cub2011(root='data', train=True, download=True, transform=data_transform)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default="ImageNet", type=str, help='Dataset to extract features')
