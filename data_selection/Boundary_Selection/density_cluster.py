...
if __name__ == '__main__':
    ...
    parser.add_argument("--cur_number", default=250, type=int, help="Number of selected samples")
    parser.add_argument("--budget", default=1000, type=int, help="Number of selected samples")
    ...
    args.indices_file_name = (f"{args.feature_path}/{args.dataset}_train_ActiveFT_euclidean_temp_0.07_lr_0.001000_scheduler_"
                              f"none_iter_300_sampleNum_{args.cur_number}.json") if args.indices_file_name is None else args.indices_file_name
